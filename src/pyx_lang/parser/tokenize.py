...
from parso.python.tokenize import (
    PythonToken, FStringNode, BOM_UTF8_STRING,
...
def _create_token_collection(version_info):
    ...
    return TokenCollection(
        ...
        whitespace, fstring_pattern_map, set(ALWAYS_BREAK_TOKENS) # type: ignore
    )
    ...
    *,
        ...
        if contstr:                                         # continued string
            ...
            if endmatch:
                ...
                yield PythonToken(
                    ...
                    contstr_start, prefix)  # type: ignore
                contstr = ''
                contline = ''
            else:
        ...
        while pos < max_:
            ...
            if (initial in numchars                      # ordinary number
                ...
                if fstring_stack and fstring_stack[-1].is_in_expr():
                    ...
                    yield PythonToken(PythonTokenTypes.ERRORTOKEN, initial, spos, prefix)
                    pos = start + 1
                else:
                    additional_prefix = prefix + token
    ...
    if fstring_stack:
        ...
        if tos.previous_lines:
            yield PythonToken(
                PythonTokenTypes.FSTRING_STRING, tos.previous_lines,
                tos.last_string_start_pos, # type: ignore
                # Never has a prefix because it can start anywhere and
                # include whitespace.
                prefix=''
